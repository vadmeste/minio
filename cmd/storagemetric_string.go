...
func _() {
	...
	_ = x[storageMetricCommitXL-28]
	_ = x[storageMetricHeal-29]
	_ = x[storageMetricLast-30]
}

const _storageMetric_name = ""

var _storageMetric_index = [...]uint16{0, 11, 18, 26, 33, 42, 49, 56, 64, 74, 84, 98, 108, 118, 128, 134, 148, 158, 166, 179, 192, 206, 217, 223, 230, 242, 254, 274, 282, 290, 294, 298}
