...
func testObjectQuorumFromMeta(obj ObjectLayer, instanceType string, dirs []string, t TestErrHandler) {
	...
	parts1, errs1 := readAllFileInfo(ctx, erasureDisks, nil, bucket, object1, "", false)
	...
	parts2, errs2 := readAllFileInfo(ctx, erasureDisks, nil, bucket, object2, "", false)
	...
	parts3, errs3 := readAllFileInfo(ctx, erasureDisks, nil, bucket, object3, "", false)
	...
	parts4, errs4 := readAllFileInfo(ctx, erasureDisks, nil, bucket, object4, "", false)
	...
	parts5, errs5 := readAllFileInfo(ctx, erasureDisks, nil, bucket, object5, "", false)
	...
	parts6, errs6 := readAllFileInfo(ctx, erasureDisks, nil, bucket, object6, "", false)
	...
	parts7, errs7 := readAllFileInfo(ctx, erasureDisks, nil, bucket, object7, "", false)
