...
// errUnsupportedBackend XL drive mode that more than > 5yrs old returns this error.
var errUnsupportedBackend = errors.New("unsupported XL version of the backend")
