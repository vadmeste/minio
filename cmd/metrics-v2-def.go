...
var metricsDef = []MetricDescription{
	getClusterCapacityTotalBytesMD(),
	getClusterCapacityFreeBytesMD(),
	getClusterCapacityUsageBytesMD(),
	getClusterCapacityUsageFreeBytesMD(),
	getNodeDriveAPILatencyMD(),
	getNodeDriveUsedBytesMD(),
	getNodeDriveFreeBytesMD(),
	getClusterDrivesOfflineTotalMD(),
	getClusterDrivesOnlineTotalMD(),
	getClusterDrivesTotalMD(),
	getNodeDrivesOfflineTotalMD(),
	getNodeDrivesOnlineTotalMD(),
	getNodeDrivesTotalMD(),
	getNodeDrivesFreeInodes(),
	getNodeDriveTotalBytesMD(),
	getUsageLastScanActivityMD(),
	getBucketUsageQuotaTotalBytesMD(),
	getBucketTrafficReceivedBytes(),
	getBucketTrafficSentBytes(),
	getBucketUsageTotalBytesMD(),
	getBucketUsageObjectsTotalMD(),
	getBucketRepLatencyMD(),
	getBucketRepFailedBytesMD(),
	getBucketRepSentBytesMD(),
	getBucketRepReceivedBytesMD(),
	getBucketRepFailedOperationsMD(),
	getBucketObjectDistributionMD(),
	getInternodeFailedRequests(),
	getInternodeTCPDialTimeout(),
	getInternodeTCPAvgDuration(),
	getInterNodeSentBytesMD(),
	getInterNodeReceivedBytesMD(),
	getS3SentBytesMD(),
	getS3ReceivedBytesMD(),
	getS3RequestsInFlightMD(),
	getS3RequestsInQueueMD(),
	getIncomingS3RequestsMD(),
	getS3RequestsTotalMD(),
	getS3RequestsErrorsMD(),
	getS3Requests4xxErrorsMD(),
	getS3Requests5xxErrorsMD(),
	getS3RequestsCanceledMD(),
	getS3RejectedAuthRequestsTotalMD(),
	getS3RejectedHeaderRequestsTotalMD(),
	getS3RejectedTimestampRequestsTotalMD(),
	getS3RejectedInvalidRequestsTotalMD(),
	getCacheHitsTotalMD(),
	getCacheHitsMissedTotalMD(),
	getCacheUsagePercentMD(),
	getCacheUsageInfoMD(),
	getCacheUsedBytesMD(),
	getCacheTotalBytesMD(),
	getCacheSentBytesMD(),
	getHealObjectsTotalMD(),
	getHealObjectsHealTotalMD(),
	getHealObjectsFailTotalMD(),
	getHealLastActivityTimeMD(),
	getNodeOnlineTotalMD(),
	getNodeOfflineTotalMD(),
	getMinIOVersionMD(),
	getMinIOCommitMD(),
	getS3TTFBDistributionMD(),
	getMinioFDOpenMD(),
	getMinioFDLimitMD(),
	getMinioProcessIOWriteBytesMD(),
	getMinioProcessIOReadBytesMD(),
	getMinioProcessIOWriteCachedBytesMD(),
	getMinioProcessIOReadCachedBytesMD(),
	getMinIOProcessSysCallRMD(),
	getMinIOProcessSysCallWMD(),
	getMinIOGORoutineCountMD(),
	getMinIOProcessStartTimeMD(),
	getMinIOProcessUptimeMD(),
	getMinIOProcessResidentMemory(),
	getMinIOProcessCPUTime(),
	getTransitionPendingTasksMD(),
	getTransitionActiveTasksMD(),
	getExpiryPendingTasksMD(),
	getNodeScannerObjectsScanned(),
	getNodeScannerVersionsScanned(),
	getNodeScannerDirectoriesScanned(),
	getNodeScannerBucketScansStarted(),
	getNodeScannerBucketScansFinished(),
	getNodeILMVersionsScanned(),
	getNodeIAMLastSyncDuration(),
	getNodeIAMSinceLastSync(),
	getNodeIAMSyncSuccesses(),
	getNodeIAMSyncFailures(),
	getMinIONotifyCurrentSendInProgress(),
	getMinIONotifyTargetQueueLength(),
	getMinIOAuditTargetQueueLength(),
	getMinIOAuditTotalMessages(),
	getMinIOAuditFailedMessages(),
	getClusterTransitionedBytesMD(),
	getClusterTransitionedObjectsMD(),
	getClusterTransitionedVersionsMD(),
	getClusterKMSOnline(),
	getClusterKMSRequestsSuccess(),
	getClusterKMSRequestsError(),
	getClusterKMSRequestsFail(),
	getClusterKMSUptime(),
}
